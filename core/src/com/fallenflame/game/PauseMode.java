...
public class PauseMode implements Screen, InputProcessor {
    ...
    public void render(float delta) {
        ...
        displayFont.setColor(hoverStates[0] == 1 ? Color.YELLOW : Color.WHITE);
        ...
        displayFont.setColor(hoverStates[1] == 1 ? Color.YELLOW : Color.WHITE);
        ...
        displayFont.setColor(hoverStates[2] == 1 ? Color.YELLOW : Color.WHITE);
        ...
        displayFont.setColor(hoverStates[3] == 1 ? Color.YELLOW : Color.WHITE);
